...
export function fetchCompanyApplicationDetail(applicationId) {
  return request(`/applications/company-view/${applicationId}`);
}
...
export function fetchPublishedAnnouncements() {
  return request('/admin/announcements/published');
}
