<template>
  <div class="app-shell">
    <header class="top-nav">
      <div class="container nav-top">
        ...
        <div class="nav-actions">
          ...
          <button class="btn btn-outline locale-btn" @click="toggleLocale">{{ locale === 'zh' ? 'EN' : '中' }}</button>
    ...
    <StudentAnnouncementBar v-if="showStudentAnnouncementBar" />
...
import StudentAnnouncementBar from "./components/StudentAnnouncementBar.vue";
...
const showStudentAnnouncementBar = computed(() => isAuthed.value && role.value === "student" && route.name !== "login");
...
.top-nav {
  ...
  box-shadow: 0 8px 18px rgba(15, 31, 23, 0.04);
}
